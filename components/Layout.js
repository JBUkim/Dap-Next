...
export default function Layout({ title, children }) {
  ...
  return (
    <>
      <Head>
        <title>{title ? title + " - Dap" : "Dap"}</title>
      ...
      <div>
        <header aria-label="Site Header" className="bg-white">
          <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              <div className="flex-1 md:flex md:items-center md:gap-12">
                <Link href="/" className="flex">
                  ...
                  <span className="inline-block h-10 w-32 rounded-lg bg-teal-600"></span>
                </Link>
              </div>
              ...
              <div className="md:flex md:items-center md:gap-12">
                <nav aria-label="Site Nav" className="hidden md:block">
                  <ul className="flex items-center gap-6 text-sm">
                    ...
                    <li>
                      <Link className="text-gray-500 transition hover:text-gray-500/75" href="/post">
                        Post
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="flex items-center gap-4">
                  {/* <div className="sm:flex sm:gap-4">
                    <Link className="rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white shadow" href="/signin">
                      Sign In
                    </Link>

                    <div className="hidden sm:flex">
                      <Link className="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600" href="/signup">
                        Sign Up
                      </Link>
                    </div>
                  </div> */}
            ...
            bg-teal-600 bg-opacity-80 px-4 py-2 text-sm font-medium
                              ...
                              <div className="px-1 py-1 ">
                                ...
                                <Menu.Item>
                                  {({ active }) => (
                                    ...
                                    >
                                      {active ? (
                                        <ArrowUturnRightIcon className="mr-2 h-5 w-5" aria-hidden="true" />
                                      ) : (
                                        <ArrowUturnRightIcon className="mr-2 h-5 w-5" aria-hidden="true" />
                                      )}
                                      LogOut
        ...
        <footer aria-label="Site Footer" className="bg-gray-100">
          <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">Copyright &copy; 2023 Dap</p>
